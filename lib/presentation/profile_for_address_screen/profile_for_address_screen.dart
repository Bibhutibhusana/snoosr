...
class ProfileForAddressScreen extends GetWidget<ProfileForAddressController> {
  @override
                                                                  ...
                                                                  children: [
                                                                    GestureDetector(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            child: SvgPicture.asset(ImageConstant.imgBackbtn4, fit: BoxFit.fill))),
                                                                    Padding(
                                                                        padding: EdgeInsets.only(
                                                                            top: getVerticalSize(
                                                                                9.00),
