...
class Timing1Screen extends GetWidget<Timing1Controller> {
  @override
                                                                    ...
                                                                    Container(
                                                                        ...
                                                                        child: Stack(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Align(alignment: Alignment.topCenter, child: Padding(padding: EdgeInsets.only(right: getHorizontalSize(7.00), bottom: getVerticalSize(10.00)), child: Container(height: getVerticalSize(188.00), width: getHorizontalSize(358.00), child: SvgPicture.asset(ImageConstant.imgGroup12, fit: BoxFit.fill)))),
                                                                              Align(
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                                                                Text("lbl_rs_12100".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textstylesfprobold271.copyWith(fontSize: getFontSize(27))),
                                                                                Padding(padding: EdgeInsets.only(right: getHorizontalSize(20.00)), child: Text("lbl_rs_2099".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textstylesfprobold272.copyWith(fontSize: getFontSize(27))))
                                                                              ]),
                                                                              Padding(
                                                                                  padding: EdgeInsets.only(top: getVerticalSize(2.00)),
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                                                                    Padding(padding: EdgeInsets.only(left: getHorizontalSize(15.00)), child: Text("lbl_most_savings".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textstylesfprobold131.copyWith(fontSize: getFontSize(13)))),
                                                                                    Padding(padding: EdgeInsets.only(right: getHorizontalSize(48.00)), child: Text("lbl_most_popular".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textstylesfprobold132.copyWith(fontSize: getFontSize(13))))
                                                                                  ])),
                                                                              Padding(
                                                                                  padding: EdgeInsets.only(top: getVerticalSize(31.00)),
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                                                                    Padding(padding: EdgeInsets.only(left: getHorizontalSize(19.00), bottom: getVerticalSize(3.00)), child: Text("lbl_6_months".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textstylesfprobold171.copyWith(fontSize: getFontSize(17)))),
                                                                                    Padding(padding: EdgeInsets.only(top: getVerticalSize(3.00), right: getHorizontalSize(54.00)), child: Text("lbl_1_month".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textstylesfprobold17.copyWith(fontSize: getFontSize(17))))
                                                                                  ])),
                                                                              Align(alignment: Alignment.centerRight, child: Container(width: getHorizontalSize(156.00), margin: EdgeInsets.only(left: getHorizontalSize(167.00), top: getVerticalSize(5.00)), child: Text("msg_see_faq_for_pr".tr, maxLines: null, textAlign: TextAlign.left, style: AppStyle.textstylesfprolight10.copyWith(fontSize: getFontSize(10))))),
                                                                              Align(alignment: Alignment.centerRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(298.00), top: getVerticalSize(16.00), right: getHorizontalSize(5.00)), child: Container(height: getSize(20.00), width: getSize(20.00), child: SvgPicture.asset(ImageConstant.imgTicksvgrepoco, fit: BoxFit.fill))))
                                                                            ])))
                                                          ]))
                                                ]))),
                                    Align(
