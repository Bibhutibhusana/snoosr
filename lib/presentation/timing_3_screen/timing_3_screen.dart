...
class Timing3Screen extends GetWidget<Timing3Controller> {
  @override
                                                                              ...
                                                                              Align(
                                                                                  ...
                                                                                  child: Container(
                                                                                      ...
                                                                                      child: Stack(alignment: Alignment.bottomLeft, children: [
                                                                                        Align(alignment: Alignment.topLeft, child: Container(width: getHorizontalSize(175.00), margin: EdgeInsets.only(bottom: getVerticalSize(10.00)), padding: EdgeInsets.only(left: getHorizontalSize(25.00), top: getVerticalSize(9.00), bottom: getVerticalSize(19.00)), decoration: AppDecoration.textstylesfprobold273, child: Text("lbl_rs_5999".tr, maxLines: null, textAlign: TextAlign.left, style: AppStyle.textstylesfprobold273.copyWith(fontSize: getFontSize(27))))),
                                                                                        Align(
                                                                                            alignment: Alignment.bottomLeft,
                                                                                            child: Container(
                                                                                                margin: EdgeInsets.only(top: getVerticalSize(10.00)),
                                                                                                decoration: BoxDecoration(color: ColorConstant.orange200, borderRadius: BorderRadius.circular(getHorizontalSize(8.00))),
                                                                                                child: Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                                                  Padding(padding: EdgeInsets.only(left: getHorizontalSize(49.00), top: getVerticalSize(52.00), bottom: getVerticalSize(19.00)), child: Text("lbl_3_months".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textstylesfprobold173.copyWith(fontSize: getFontSize(17)))),
                                                                                                  Padding(padding: EdgeInsets.only(left: getHorizontalSize(17.00), top: getVerticalSize(59.00), right: getHorizontalSize(12.00), bottom: getVerticalSize(12.00)), child: Container(height: getSize(20.00), width: getSize(20.00), child: SvgPicture.asset(ImageConstant.imgTicksvgrepoco, fit: BoxFit.fill)))
                                                                                                ])))
                                                                                      ]))),
                                                                              Align(alignment: Alignment.topCenter, child: Padding(padding: EdgeInsets.only(right: getHorizontalSize(7.00), bottom: getVerticalSize(10.00)), child: Container(height: getVerticalSize(188.00), width: getHorizontalSize(358.00), child: SvgPicture.asset(ImageConstant.imgGroup122, fit: BoxFit.fill)))),
                                                                              Align(
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(
                                                                                  ...
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                                                                    Container(
                                                                                        margin: EdgeInsets.only(left: getHorizontalSize(19.00), bottom: getVerticalSize(3.00)),
                                                                                        child: RichText(
                                                                                            text: TextSpan(children: [
                                                                                              TextSpan(text: "lbl_6".tr, style: TextStyle(color: ColorConstant.black900, fontSize: getFontSize(17), fontFamily: 'SF Pro', fontWeight: FontWeight.w700)),
                                                                                              ...
                                                                                              TextSpan(text: "lbl_months".tr, style: TextStyle(color: ColorConstant.black900, fontSize: getFontSize(17), fontFamily: 'SF Pro', fontWeight: FontWeight.w700))
                                                                                            ]),
